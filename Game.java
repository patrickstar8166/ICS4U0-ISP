...
public class Game extends JFrame implements Runnable{
   ...
   public static String[] names = {"Saskatoon Berries", "Dandelion", "Crown Tipped Coral", "Burdock", "Jack Pine", "Lobster Mushroom", "Morel Mushroom", "Cranberry", "Raspberry", "Cattail", "Lily of the Valley", "False Morel", "Gilled Mushroom", "Deadly Galerina", "Poison Ivy", "RedBaneberry", " Bulb-Bearing Water Hemlock", "Poison Hemlock", "Water Hemlock", "Blue Flag Iris"};
   ...
   "This level involves a free-roam path that you will navigate, using the arrow keys. On the map, there will be randomly spawned items. These items may be dangerous OR safe, so choose carefully! You will have to collect at least 6 right items before the 2 minute timer (right corner) runs out! Afterwards, your results will be displayed. During the game you can view your inventory by pressing \"i\". To pick up an item, press \"z\". A mini-game will be displayed where you will be asked to collect enough of the item while avoiding getting stung by the bees, using left and right arrow keys. If you are stung too much (health bar top left corner), you will not be able to collect the item. You will have successfully collected the item if the green bar (top right) is full. If you collect any inedible plants, you will lose."};
   ...
   public static Image bee, pcU, pcD, pcR, pcL, inv, endPlate, bush, sprite1, sprite2, sprite3, sprite4, background1, background2, background3, minigameChar, minigameBasket, minigameBg, minigameBee;
   ...
   */
   public Game(){
      ...
      sprite3 = t.getImage("StandingStillViewLeft.png");
      sprite4 = t.getImage("WalkingViewLeft.png");
