...
public class Level2 implements KeyListener, Runnable{
   ...
   private boolean rightHeld, leftHeld, upHeld, downHeld,  zHeld, interact, freezeLeft, end;
   private int bgOffset, charX, charW, buffer, leftBound, rightBound, upBound, bottomBound;
   ...
   public void run(){
      ...
      try{
         obj.add(new BgObject(-200,300,30,30,"Images/apple.jpg"));
         obj.add(new BgObject(-1000,300,30,30, "Images/bomb.png"));
         game();
      }
      catch(Exception e){
